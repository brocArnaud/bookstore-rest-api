...
public class CustomerRecordTest 
{
	...
	public void testSettersAndGetters() {
		...
		//--- Test setter/getter for attribute "reviewer"  ( model type : Boolean / wrapperType : Boolean )
		customerRecord.setReviewer( Boolean.valueOf(true) ) ;
		Assert.assertEquals( Boolean.valueOf(true), customerRecord.getReviewer() ) ; // Not primitive type in model
